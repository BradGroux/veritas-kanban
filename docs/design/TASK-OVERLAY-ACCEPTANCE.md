...
| Agent stop and readiness override                 | `AgentPanel`                                  | Stop: light/dark, three sizes, both motion settings, pending/failure recovery; readiness override pending                 | Pending                 |
