...
This closes the listed native Template layout/dismissal checks, not full product acceptance. Native create/edit persistence and final installed-app verification remain outstanding. The installed app, its data, and maintained documentation images/GIFs have not been updated by this change.
