...
The accepted capture pass asserted viewport and control bounds immediately before capture and added paint settling. Interaction assertions passed across all six variants in both themes at normal and enlarged text, including reduced motion, dropdown layering, nested Escape/focus restoration, retained draft state, and fixed footers. Actual Template preview and delete-confirmation cancellation passed in both themes, with opener focus restored and the record retained. All 34 variant and Template editor captures were visually inspected; menus remain above the surface, and headers, close controls, and footer actions remain visible. The [matrix and captures](evidence/popout-contract-1401/native-matrix.json) are retained as audit evidence, not maintained product documentation media.

Correction to the earlier provisional report: suspected clipping in the normal dark Task drawer was not confirmed when the original image was re-inspected and the same state was opened in the visible macOS candidate. Native screen inspection showed the complete close control and fixed Cancel/Review actions; the drawer measured x=400, y=0, width=960, height=900 in a 1360×900 viewport. No additional rendering fix is claimed for that unconfirmed observation. A [fresh Task capture](evidence/popout-contract-1401/live-task-recheck.png) records the recheck. Populated Template card action wrapping at enlarged text remains separately tracked under #1384.

The matrix used integration candidate `d181a26a7999c5ec0da456cfe30933b164a9e65e`, combining this foundation with independent Settings, Policy action, and keyboard fixes. The visible Task recheck used `4760687ad9c27827cd83b62cbd1bea9b9136d5e6`, which adds the independent server budget persistence fix without changing the packaged web payload. Candidate shell SHA-256: `5a5829cfee4dbe3877eac890920919cd181891c2cb46ebe86e2ec788cf65c830`. Packaged web index SHA-256: `58139e42dd2b55e367fab13a92c7b4ebabca9cbbe64790b67d7034fcff96070d`.
