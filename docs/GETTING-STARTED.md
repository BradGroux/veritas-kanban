...
![Dev stack running with public-safe 6.1.7 tasks](assets/v6.1.7/board-overview.png)
...
![Reviewing a task in the 6.1.7 progressive task workspace](assets/v6.1.7/task-workspace.png)
...
![Board to task-workspace tour with dummy 6.1.7 tasks](assets/v6.1.7/board-to-workspace.gif)
...
![Agent-ready task workspace](assets/v6.1.7/task-workspace.png)
