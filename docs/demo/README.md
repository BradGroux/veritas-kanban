...
The public demo video is hosted by GitHub Pages from this repository's `main` branch and `/docs` source. It is rebuilt from the same public-safe 6.1.6 screenshots used by the maintained visual tour.
...
2. Review every file in `docs/assets/v6.1.6/` for private or stale content.
