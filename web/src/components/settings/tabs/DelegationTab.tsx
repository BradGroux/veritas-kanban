...
export function DelegationTab() {
  ...
  return (
    <SettingsPage
      title="Delegation"
      description="Temporarily delegate task approval authority to an agent while you are away."
    >
      <SettingsSection
        title="Approval Delegation"
        description="Set a bounded delegate, duration, task scope, and critical-task exclusion."
        tone="advanced"
      >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Select
                  ...
                  value={scopeType}
                  onChange={(value) =>
                    value && setScopeType(value as 'all' | 'project' | 'priority')
                  }
                  data={[
