...
- [Example video](https://github.com/BradGroux/veritas-kanban/issues/68) — Publish the existing demo reel to a hosted player (YouTube, Vimeo, or first-party page) and link it from the README for easy sharing
