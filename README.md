...
![Veritas Kanban 6.1.7 board, task workspace, Settings, and command palette tour](docs/assets/v6.1.7/board-to-workspace.gif)
...
![Agent orchestration board](docs/assets/v6.1.7/board-overview.png)

![Resizable Workbench panel](docs/assets/v6.1.7/workbench-panel.png)
...
![Squad Chat coordination](docs/assets/v6.1.7/squad-chat.png)
...
![Agent provider settings](docs/assets/v6.1.7/agent-providers.png)
...
![Progressive task workspace](docs/assets/v6.1.7/task-workspace.png)
...
These 6.1.7 captures use release-safe dummy content against the current app surfaces. See the [v6 Visual Tour](docs/V6-VISUAL-TOUR.md) for the maintained media index and capture rules.

### Desktop

| Board and task-workspace tour                                                | Current desktop board                                         |
| ---------------------------------------------------------------------------- | ------------------------------------------------------------- |
| ![6.1.7 board and workspace tour](docs/assets/v6.1.7/board-to-workspace.gif) | ![6.1.7 desktop board](docs/assets/v6.1.7/board-overview.png) |

| Workbench panel                                                  | Agent provider settings                                          |
| ---------------------------------------------------------------- | ---------------------------------------------------------------- |
| ![6.1.7 Workbench panel](docs/assets/v6.1.7/workbench-panel.png) | ![6.1.7 agent providers](docs/assets/v6.1.7/agent-providers.png) |

| Squad Chat coordination                                | Notification and reply adapters                                              |
| ------------------------------------------------------ | ---------------------------------------------------------------------------- |
| ![6.1.7 Squad Chat](docs/assets/v6.1.7/squad-chat.png) | ![6.1.7 notification adapters](docs/assets/v6.1.7/notification-adapters.png) |

| Task workspace                                                 | Maintenance Center                                                     |
| -------------------------------------------------------------- | ---------------------------------------------------------------------- |
| ![6.1.7 task workspace](docs/assets/v6.1.7/task-workspace.png) | ![6.1.7 Maintenance Center](docs/assets/v6.1.7/maintenance-center.png) |

### Mobile/PWA

| Mobile board                                               | Mobile board to workspace/settings flow                  |
| ---------------------------------------------------------- | -------------------------------------------------------- |
| ![6.1.7 mobile board](docs/assets/v6.1.7/mobile-board.png) | ![6.1.7 mobile flow](docs/assets/v6.1.7/mobile-flow.gif) |
