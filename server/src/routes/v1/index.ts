...
import { timeBreakdownRoutes } from '../time-breakdowns.js';
...
v1Router.use('/evidence', reportAccess, evidenceRoutes);
v1Router.use('/time-breakdowns', reportAccess, timeBreakdownRoutes);
...
v1Router.use('/reflections', workflowAccess, reflectionRoutes);
